...
def home():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            error_message = str(e)
    return render_template('home.html', departure_weather=departure_weather, arrival_weather=arrival_weather, error=error_message, datalist_options = datalist_options)
...
def city():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            error_message = str(e)
    return render_template('city.html', arrival_weather=arrival_weather, error=error_message, datalist_options = datalist_options)

@app.route('/flight.html', methods=['GET', 'POST'])
def flight():
    departure_weather = None
    arrival_weather = None
    error_message = None
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            error_message = str(e)
    return render_template('flight.html', departure_weather=departure_weather, arrival_weather=arrival_weather, error=error_message)
