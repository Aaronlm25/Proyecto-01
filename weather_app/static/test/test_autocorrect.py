...
def test_upper_case(city_data : set):
    """
...
def test_lower_case(city_data : set):
    """
    Test para ver que dada una ciudad bien escrita esta se modifique de tal modo
...
def test_mixed_upper_lower_case(city_data : set):
    """
    Test para ver que dada una ciudad bien escrita esta se modifique de tal modo
...
def test_accuracy_basic(city_data : set):
    """
    Test para ver que dada una ciudad bien escrita esta se modifique de tal modo
    ...
    for character_set in arbitrary_sets:
        ...
        assert revise(arbitrary_string) == []
    assert revise('') == []