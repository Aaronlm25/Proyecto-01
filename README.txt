...
6. Agregar API Key.
Para poder hacer uso del programa es necesario crear un archivo,el archivo se debe llamar ".env"(sin las comillas) dentro de weather app a la par de index.py; dentro de este archivo deberás escribir textualmente la palabra: KEY=(aquí debes escribir tu API Key, omite los paréntesis), ejemplo:
